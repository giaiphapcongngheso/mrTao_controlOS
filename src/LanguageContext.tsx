...
const translations: TranslationDictionary = {
  vi: {
    ...
    header: {
      ...
      os: 'MR.TÁO OS',
      titleToday: 'Tổng quan Hôm nay',
      titleChecklist: 'Hồ sơ Checklist ca trực',
      titleTasks: 'Giao phó công việc',
      titleKPI: 'Chỉ số hiệu kỹ (KPI)',
      titleSOP: 'Ngoại lệ & Lỗi SOP',
      titleReports: 'Báo cáo tổng kết ca',
      titleHandbook: 'Sổ tay Vận hành chuẩn (SOP)',
      titleStaff: 'Phân quyền cộng tác viên',
