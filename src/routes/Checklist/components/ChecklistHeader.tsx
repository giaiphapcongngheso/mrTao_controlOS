      ...
      <div className="relative z-10 shrink-0 self-start sm:self-auto">
        {(subTab === 'today' || subTab === 'process') && canCreate && (
          <Button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white font-extrabold text-sm uppercase tracking-wider rounded-xl shadow-xs hover:shadow-md transition-all duration-200 cursor-pointer active:scale-95"
          >
