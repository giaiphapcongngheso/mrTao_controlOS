...
interface ChecklistContentAreaProps {
  ...
  isItemLate: (item: ChecklistItem) => boolean;
...
export default function ChecklistContentArea({
  filteredCategories,
  subTab,
  expandedCategoryId,
  onToggleExpand,
        ...
        {filteredCategories.length === 0 ? (
          <div className="bg-white p-16 text-center rounded-2xl border border-dashed border-slate-200 space-y-4 shadow-2xs">
            ...
            <Button
              ...
              variant="outline"
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-[10.5px] font-black text-slate-800 uppercase tracking-wider hover:bg-slate-100 hover:border-slate-300 transition-all cursor-pointer active:scale-95"
            >
              Đặt lại bộ lọc
            </Button>
          </div>
                      ...
                      {editingCategoryId === cat.id ? (
                        ...
                        >
                          <Input
                            ...
                            className="bg-slate-50 border border-slate-350 focus:border-slate-800 focus:outline-none px-2.5 py-1 rounded-lg text-xs font-bold w-48 shadow-2xs"
                          />
                          <Button
                            type="submit"
                            className="px-2.5 py-1 bg-slate-900 hover:bg-slate-800 text-white text-[10px] rounded-md font-black uppercase tracking-wider cursor-pointer transition-colors"
                          >
                            Lưu
                          </Button>
                        </form>
                      ...
                      cat.tasks.map((item) => {
                        ...
                        return (
                          <div
                            ...
                            } ${isCurrentlyEditing ? 'bg-white p-3.5 border-l-2 border-slate-850' : ''}`}
                          >
                                ...
                                {isCurrentlyEditing ? (
                                  ...
                                  >
                                    <Textarea
                                      ...
                                      className="flex-1 min-w-0 h-9 min-h-[36px] py-1.5 resize-none overflow-hidden text-xs font-bold text-slate-700 bg-slate-50 border border-slate-250 rounded-lg px-2.5 focus:outline-none focus:border-slate-800 leading-normal"
                                    />
                                    <Input
                                      type="time"
                                      ...
                                      className="text-xs font-mono font-bold text-slate-650 bg-slate-50 border border-slate-250 rounded-lg px-2 py-1.5 focus:outline-none"
                                    />
                    ...
                    {subTab === 'process' && permissions.canCreate && (
                      <div className="py-3 px-4 text-left">
                        <Button
                          ...
                          variant="ghost"
                          className="inline-flex items-center gap-1.5 text-xs font-black text-slate-800 hover:text-slate-950 hover:underline cursor-pointer active:scale-95"
                        >
