 ...
 */
const PlanMonthView = React.memo(function PlanMonthView({ plans }: PlanMonthViewProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr_260px] gap-4">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs font-semibold text-slate-400 truncate">{p.ownerName}</span>
                      </div>
                    </div>
                  </div>
                  {/* Progress bar */}
        ...
        <Card className="border border-slate-100/80 p-0 shadow-2xs bg-white rounded-2xl py-4">
          <CardContent className="px-4 p-0">
            <h4 className="text-sm font-black text-slate-700 mb-3">Bảng kế hoạch tháng</h4>
            ...
            <div className="pt-2 border-t border-slate-100 space-y-1.5">
              ...
              {[
                ...
                <div key={rule} className="flex items-start gap-1.5">
                  ...
                  <span className="text-xs font-medium text-slate-400 leading-normal">{rule}</span>
                </div>
              ))}
            </div>
          </CardContent>
