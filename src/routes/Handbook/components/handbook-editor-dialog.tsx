              ...
              <FormItem className="grid gap-0">
                ...
                <div className="rounded-xl border border-slate-200 overflow-hidden bg-slate-50">
                  ...
                  <div
                    ...
                    className="rich-text-content min-h-[300px] max-h-[450px] p-4 bg-white text-slate-800 text-xs font-semibold focus:outline-none overflow-y-auto leading-relaxed text-left select-text rounded-b-xl
                              ...
                              [&_table]:w-full [&_table]:my-3 [&_table]:border-collapse [&_table]:border [&_table]:border-slate-200
                              [&_thead]:bg-slate-50
                              [&_th]:border [&_th]:border-slate-200 [&_th]:p-2 [&_th]:text-xs [&_th]:font-extrabold [&_th]:text-slate-700 [&_th]:text-left [&_th]:bg-slate-50
                              [&_td]:border [&_td]:border-slate-200 [&_td]:p-2 [&_td]:text-xs [&_td]:text-slate-600 [&_td]:leading-relaxed [&_td]:align-top
